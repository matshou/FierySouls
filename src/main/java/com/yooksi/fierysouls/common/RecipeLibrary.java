...
{
	MATCHBOX_RECIPE(new ItemStack(ResourceLibrary.MATCHBOX.getItem(), 1), new Object[] { Items.gunpowder, Items.stick, Items.paper  }, true, ResourceLibrary.MATCHBOX),
	GLOWSTONE_CRYSTAL_RECIPE(new ItemStack(ResourceLibrary.GLOWSTONE_CRYSTAL.getItem(), 1), new Object[] { "x", "xyx", "x", 'x', Items.glowstone_dust, 'y', Items.coal }, false, ResourceLibrary.GLOWSTONE_CRYSTAL),
	TORCH_UNLIT_RECIPE_1(new ItemStack(ResourceLibrary.TORCH_UNLIT.getItem(), 1), new Object[] { "x", "y", 'x', Items.coal, 'y', Items.stick }, false, ResourceLibrary.TORCH_UNLIT),
	TORCH_UNLIT_RECIPE_2(new ItemStack(ResourceLibrary.TORCH_UNLIT.getItem(), 1), new Object[] { "x", "y", 'x', new ItemStack(Items.coal, 1, 1), 'y', Items.stick }, false, ResourceLibrary.TORCH_UNLIT);  // Charcoal version
